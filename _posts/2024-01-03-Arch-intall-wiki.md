...
Minimal arch install with [arch-install]() or [arch-acetate]() either way 
just some things for me to remember during install. also if it helps !
also this is not my guide i just use [arch-acetate]() but i will make this even better. thanks [Aciel.](https://github.com/XxAcielxX/arch-plasma-install)
